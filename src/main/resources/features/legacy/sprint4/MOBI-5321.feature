...
Feature: Sprint 4 Story
  ...
  User Story:
  - As a reader I want to use my Google login to create a digital account so that I have one less email/password that I need to be remember
  ...
  {color:#ff0000}Note: This ticket is focused on Google. {color}
  ...
  @MCCDV015-[118:120]
  Scenario Outline: Create digital account with social login (Google)
    Given Steps
